...
- [GPU全量校验手册.md](./GPU全量校验手册.md)：结果表已按 3070 日志回填，**总判定失败**。明细 [实测记录](./2026-09-06_RTX3070容器实测记录.md)。
- [docker-cpu-smoke-findings.md](./docker-cpu-smoke-findings.md)：2026-09-04 CPU 栈，与本次 GPU 无关。
