    ...
    public IActionResult GetStatus(string taskId)
    {
        ...
        return Ok(new
        {
            ...
            report = status.Report != null ? new
            {
                ...
                status.Report.MeanPrecisionAtK,
                status.Report.MeanRecallAtK,
                status.Report.MeanMRR,
                status.Report.MeanPrecisionAt10,
                status.Report.MeanRecallAt10,
                status.Report.MeanFaithfulness,
                status.Report.TotalVerifiedClaims,
                status.Report.TotalHallucinatedClaims,
