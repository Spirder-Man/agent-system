...
<template>
  <div class="login-page">
      ...
      <div class="login-card">
        <div class="shield-decoration">
          <svg class="security-icon" viewBox="0 0 100 100" fill="none">
            ...
            <path
              d="M50 22 L75 28 C75 28 78 30 78 35 L76 55 C75 72 50 82 50 82 C50 82 25 72 24 55 L22 35 C22 30 25 28 25 28 L50 22 Z"
            ...
            <path
              d="M45 48 V40 C45 32 55 32 55 40 V48"
              fill="none"
              stroke="white"
              stroke-width="3.5"
        ...
        <div class="other-login">
          ...
          <div class="login-tabs">
            <button
              :class="['tab-btn', { active: activeLoginTab === 'password' }]"
              @click="activeLoginTab = 'password'"
            >
    ...
    <!-- ⑤ 底部 -->
    <footer class="login-footer">© 2026 苍卫 化工智能生产运营中心</footer>
  </div>
</template>
...
.security-icon circle:nth-child(n + 8) {
  animation: pulse 3s ease-in-out infinite;
  transform-origin: center;
}
.security-icon circle:nth-child(8) {
  animation-delay: 0s;
}
.security-icon circle:nth-child(9) {
  animation-delay: 0.75s;
}
.security-icon circle:nth-child(10) {
  animation-delay: 1.5s;
}
.security-icon circle:nth-child(11) {
...
.tab-btn.active .icon-account {
  background: linear-gradient(135deg, #059669, #047857);
  color: white;
  box-shadow: 0 4px 12px rgba(5, 150, 105, 0.3);
}
.tab-btn.active .icon-sso {
  background: linear-gradient(135deg, #2563eb, #1d4ed8);
  color: white;
  box-shadow: 0 4px 12px rgba(37, 99, 235, 0.3);
}
.tab-btn.active .icon-qrcode {
